...
if fileSuf != "":
    fileSuf += "_"
seeddir = f"/home1/igraham/Projects/hoomd_test/final_data/{fileSuf}constPhi{phi}_N{N}_seed{cmdargs.seed}_maxStrain{maxStrain}_strainStep{strainStep}_recPer10"
