...
/home1/igraham/anaconda3/envs/softmatter/bin/python shear_from_inf_quench_coarse_record.py -g 0 -s ${NUM} -i 40 -m $(( $NUM/10 + 1))e-2 -n 10000 -p 1.2
