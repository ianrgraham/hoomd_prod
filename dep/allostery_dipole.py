...
parser.add_argument('-n','--numParticles',help="Number of particles.", type=int, default=512)
...
while not(fire.has_converged()) or np.abs(log2.query('pressure') - pressure)/pressure > 1e-3:
